...
export const FEEDS = {
  ...
  state: [
    { id: 'tu_state',     name: 'Times Union',           url: 'https://news.google.com/rss/search?q=site%3Atimesunion.com+%28%28%22New+York%22+%28Assembly+OR+%22State+Senate%22+OR+Legislature+OR+Governor+OR+%22New+York+Government%22%29%29+OR+Churchill+OR+%22Pat+Ryan%22%29&hl=en-US&gl=US&ceid=US%3Aen' },
    ...
    // Capital Confidential left Substack and no longer publishes an RSS feed.
    // Re-add once a kill-the-newsletter.com feed is set up for it:
    // { id: 'capcon',    name: 'Capital Confidential',  url: 'https://kill-the-newsletter.com/feeds/<ID>.xml' },
  ...
  local: [
    ...
    { id: 'mhn',          name: 'Mid Hudson News',       url: 'https://news.google.com/rss/search?q=site%3Amidhudsonnews.com&hl=en-US&gl=US&ceid=US%3Aen' },
  ],
  opinion: [
